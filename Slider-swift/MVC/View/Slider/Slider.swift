...
class Slider: UIView, UIScrollViewDelegate {
    ...
    func setupSliderView() {
        ...
        for str: String in slides {
            ...
            imageView.kf.setImage(with: URL(string: str)) //sd_setImage(with: URL(string: str), placeholderImage: UIImage(named: "Property"))
    ...
    override func draw(_ rect: CGRect) {
        ...
        self.bringSubview(toFront: pagger)
    }
    ...
    func autoStartSlide(_ sender: Any) {
